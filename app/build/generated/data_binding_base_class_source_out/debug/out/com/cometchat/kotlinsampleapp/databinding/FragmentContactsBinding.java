...
public final class FragmentContactsBinding implements ViewBinding {
  ...
  @NonNull
  public final CometChatContacts contacts;

  private FragmentContactsBinding(@NonNull LinearLayout rootView,
      @NonNull CometChatContacts contacts) {
  ...
  public static FragmentContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.contacts;
      CometChatContacts contacts = ViewBindings.findChildViewById(rootView, id);
      if (contacts == null) {
        break missingId;
      }

      return new FragmentContactsBinding((LinearLayout) rootView, contacts);
    }
