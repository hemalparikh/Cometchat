...
public final class FragmentMessageListBinding implements ViewBinding {
  ...
  private FragmentMessageListBinding(@NonNull FrameLayout rootView,
      @NonNull CometChatMessageList messageList) {
  ...
  public static FragmentMessageListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMessageListBinding((FrameLayout) rootView, messageList);
    }
